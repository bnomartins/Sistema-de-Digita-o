...
namespace DoctrineORMModule\Proxy\__CG__\Application\Entity\Candidate;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Candidate extends \Application\Entity\Candidate\Candidate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Candidate\\Candidate' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Candidate\\Candidate' . "\0" . 'cpf', '' . "\0" . 'Application\\Entity\\Candidate\\Candidate' . "\0" . 'nome', '' . "\0" . 'Application\\Entity\\Candidate\\Candidate' . "\0" . 'social', '' . "\0" . 'Application\\Entity\\Candidate\\Candidate' . "\0" . 'nascimento', '' . "\0" . 'Application\\Entity\\Candidate\\Candidate' . "\0" . 'telefone', '' . "\0" . 'Application\\Entity\\Candidate\\Candidate' . "\0" . 'email', '' . "\0" . 'Application\\Entity\\Candidate\\Candidate' . "\0" . 'cep', '' . "\0" . 'Application\\Entity\\Candidate\\Candidate' . "\0" . 'endereco', '' . "\0" . 'Application\\Entity\\Candidate\\Candidate' . "\0" . 'bairro', '' . "\0" . 'Application\\Entity\\Candidate\\Candidate' . "\0" . 'cidade', '' . "\0" . 'Application\\Entity\\Candidate\\Candidate' . "\0" . 'estado', 'modifiedDate'];
        }
