# Sistema de Digitação / Tiping System:
...
## :page_with_curl: Instrução de Uso para o Candidato / Instruction for candidate use 
...
## :page_with_curl: Instrução de uso para o Administrador do Sistema / Instruction for Adm use
